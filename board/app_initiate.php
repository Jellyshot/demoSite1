<!-- 
  ...
  기능: 
  board 앱의 CRUD를 위한 board 테이블을 생성한다.
...
$sql = "CREATE TABLE `board` ( `id` INT(8) NOT NULL AUTO_INCREMENT , `username` VARCHAR(24) NOT NULL COMMENT 'user account' , `title` VARCHAR(100) NOT NULL COMMENT 'board title' , `contents` TEXT NOT NULL COMMENT 'board contents' , `wrtime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'wirte time' , `uptime` DATETIME on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'update time' , `hits` INT NOT NULL COMMENT 'notice hits' , PRIMARY KEY (`id`)) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_general_ci COMMENT = 'board CRUD table';";
